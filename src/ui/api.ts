...
import { DEFAULT_MODEL, isValidModelSelection, normalizeModelSelection, supportedModels } from '../agent/models';
...
function parseConfigBody(state: MutableProfileState, body: unknown): ParsedConfig {
  ...
  const modelValid = rawModel !== '' && isValidModelSelection(agentKind, rawModel);
